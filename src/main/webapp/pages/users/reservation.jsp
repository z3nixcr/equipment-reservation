        ...
        <table class="items-table">
          ...
          <c:forEach var="item" items="${items}" varStatus="i">
            <tr>
              ...
              <td>
                <a href="${pageContext.request.contextPath}/ServletReservation?action=edit&id=${item.idEquipment}">
              ...
              <td>
                <a href="${pageContext.request.contextPath}/ServletReservation?action=delete&id=${item.idEquipment}">
